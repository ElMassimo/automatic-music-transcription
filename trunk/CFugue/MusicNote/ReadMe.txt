...
For other platforms, use the CMake build system. (Note: CFugue uses C++0x with std threads and lambda expressions - so please ensure that you are using latest GNU C++ compiler (ver 4.6 or above) to succeed the build.)
...
\vs-build: contains the VC solution/project files to build the source code. Also contains the Doxyfile to generate the documentation
...
Copyright (C) 2012 Gopalakrishna Palem 
